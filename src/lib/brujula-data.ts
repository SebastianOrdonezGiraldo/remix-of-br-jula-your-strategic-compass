...
export const CHALLENGES: Challenge[] = [
  {
    ...
    route: [
      {
        title: "Comprendimos tu desafío",
        detail: "Vender más no siempre es vender a todos.",
        tag: "Comprensión",
      },
      {
        title: "Fortalecer capacidades comerciales",
        detail: "Diagnóstico y modelo comercial.",
        tag: "Capacidad",
      },
      {
        title: "Explorar herramientas de marketing",
        detail: "Marca, contenido y canales digitales.",
        tag: "Capacidad",
      },
      {
        title: "Proyecto aplicado con estudiantes",
        detail: "Investigación de mercado o estrategia de canal.",
        tag: "Proyecto",
      },
      {
        title: "Capacitación especializada",
        detail: "Formación a la medida para tu equipo.",
        tag: "Formación",
      },
      {
        title: "Beneficios disponibles",
        detail: "Becas y descuentos para tu organización.",
        tag: "Beneficio",
      },
      {
        title: "Construyamos juntos",
        detail: "Un consultor te acompaña en el siguiente paso.",
        tag: "Conexión",
      },
    ],
  },
  {
    ...
    route: [
      {
        title: "Comprendimos tu desafío",
        detail: "Identificamos dónde se pierde valor.",
        tag: "Comprensión",
      },
      {
        title: "Optimización de procesos",
        detail: "Mapeo, cuellos de botella y rediseño.",
        tag: "Capacidad",
      },
      {
        title: "Automatización de tareas",
        detail: "Herramientas y flujos digitales.",
        tag: "Capacidad",
      },
      {
        title: "Proyecto aplicado",
        detail: "Un equipo interdisciplinario acompaña la mejora.",
        tag: "Proyecto",
      },
      {
        title: "Formación al equipo",
        detail: "Lean, gestión operativa, mejora continua.",
        tag: "Formación",
      },
      {
        title: "Construyamos juntos",
        detail: "Coordinamos la siguiente conversación.",
        tag: "Conexión",
      },
    ],
  },
  {
    ...
    route: [
      {
        title: "Comprendimos tu desafío",
        detail: "Digitalizar no es lo mismo que transformar.",
        tag: "Comprensión",
      },
      {
        title: "Diagnóstico de madurez digital",
        detail: "Punto de partida claro y realista.",
        tag: "Capacidad",
      },
      {
        title: "Casos de uso con IA",
        detail: "Priorización de oportunidades reales.",
        tag: "Capacidad",
      },
      {
        title: "Proyecto piloto",
        detail: "Un prototipo funcional con estudiantes y docentes.",
        tag: "Proyecto",
      },
      {
        title: "Formación en datos e IA",
        detail: "Programas para líderes y equipos técnicos.",
        tag: "Formación",
      },
      {
        title: "Construyamos juntos",
        detail: "Explora una alianza de innovación aplicada.",
        tag: "Conexión",
      },
    ],
  },
  {
    ...
    route: [
      {
        title: "Comprendimos tu desafío",
        detail: "El talento define el techo de la organización.",
        tag: "Comprensión",
      },
      {
        title: "Desarrollo de liderazgo",
        detail: "Programas para líderes actuales y futuros.",
        tag: "Capacidad",
      },
      {
        title: "Cultura y clima",
        detail: "Diagnóstico y planes de intervención.",
        tag: "Capacidad",
      },
      {
        title: "Formación a la medida",
        detail: "Rutas diseñadas para tu equipo.",
        tag: "Formación",
      },
      {
        title: "Beneficios para colaboradores",
        detail: "Educación continua y becas.",
        tag: "Beneficio",
      },
      {
        title: "Construyamos juntos",
        detail: "Diseñamos una ruta para tu gente.",
        tag: "Conexión",
      },
    ],
  },
  {
    ...
    route: [
      {
        title: "Comprendimos tu desafío",
        detail: "Detrás de los números hay decisiones.",
        tag: "Comprensión",
      },
      {
        title: "Análisis financiero",
        detail: "Estructura de costos y rentabilidad.",
        tag: "Capacidad",
      },
      {
        title: "Planeación financiera",
        detail: "Proyecciones y toma de decisiones.",
        tag: "Capacidad",
      },
      {
        title: "Proyecto aplicado",
        detail: "Un equipo acompaña un diagnóstico específico.",
        tag: "Proyecto",
      },
      {
        title: "Formación en finanzas",
        detail: "Programas para no financieros y líderes.",
        tag: "Formación",
      },
      {
        title: "Construyamos juntos",
        detail: "Definimos el mejor punto de partida.",
        tag: "Conexión",
      },
    ],
  },
  {
    ...
    route: [
      {
        title: "Comprendimos tu desafío",
        detail: "La logística conecta promesa y experiencia.",
        tag: "Comprensión",
      },
      ...
      {
        title: "Proyecto aplicado",
        detail: "Estudiantes acompañan un caso real.",
        tag: "Proyecto",
      },
  ...
  },
  {
    ...
    route: [
      {
        title: "Comprendimos tu desafío",
        detail: "Sostenibilidad genera valor, no solo reporte.",
        tag: "Comprensión",
      },
      ...
      {
        title: "Proyecto aplicado",
        detail: "Un equipo interdisciplinario acompaña.",
        tag: "Proyecto",
      },
  ...
  },
  {
    ...
    route: [
      {
        title: "Comprendimos tu desafío",
        detail: "La estrategia es tomar decisiones difíciles.",
        tag: "Comprensión",
      },
      {
        title: "Diagnóstico estratégico",
        detail: "Dónde están hoy y dónde quieren estar.",
        tag: "Capacidad",
      },
  ...
  },
  {
    ...
    route: [
      {
        title: "Comprendimos tu desafío",
        detail: "Cada mercado tiene sus reglas.",
        tag: "Comprensión",
      },
      {
        title: "Inteligencia de mercados",
        detail: "Investigación y priorización.",
        tag: "Capacidad",
      },
      { title: "Estrategia de entrada", detail: "Canales, alianzas y modelo.", tag: "Capacidad" },
      {
        title: "Proyecto aplicado",
        detail: "Estudiantes investigan un mercado meta.",
        tag: "Proyecto",
      },
      {
        title: "Formación en comercio internacional",
        detail: "Programas especializados.",
        tag: "Formación",
      },
      { title: "Construyamos juntos", detail: "Un consultor te contacta.", tag: "Conexión" },
    ],
  },
  {
    ...
    route: [
      { title: "Está bien no saberlo aún", detail: "Empezamos por escuchar.", tag: "Comprensión" },
      {
        ...
        detail: "Un panorama general para ubicarte.",
        tag: "Capacidad",
      },
      {
        title: "Conversación exploratoria",
        detail: "Sin compromiso, con un consultor.",
        tag: "Conexión",
      },
    ],
  },
...
export type RutaTipo =
  "comercial" | "operacional" | "digital" | "organizacional" | "sostenibilidad";
...
const lecturaBase =
  ...
  (userAnswers: string[], challengeTitle: string): string[] => {
    ...
    if (a1)
      ideas.push(
        `Compartiste algo importante: "${a1}". Esta descripción nos da un punto de partida claro para orientar la conversación.`,
      );
    if (a2)
      ideas.push(
        `También mencionaste: "${a2}". Ese matiz cambia por completo la forma de abordar el reto y define dónde conviene ${verboSintesis} primero.`,
      );
    if (a3)
      ideas.push(
        `Finalmente nos dijiste: "${a3}". Con esta información podemos priorizar sin asumir más de lo necesario.`,
      );
    if (ideas.length < 4) {
      ideas.push(
...
export const RUTAS_INICIALES: Record<RutaTipo, RutaInicialDef> = {
  comercial: {
    ...
    descripcionCorta:
      "Orientada a fortalecer cómo tu organización llega, conecta y crece con sus clientes.",
    capacidades: [
  ...
  operacional: {
    ...
    descripcionCorta:
      "Enfocada en cómo el día a día de tu organización puede producir más valor con menos fricción.",
    capacidades: [
  ...
  digital: {
    ...
    descripcionCorta:
      "Pensada para usar datos, automatización e inteligencia artificial con un propósito claro.",
    capacidades: [
  ...
  organizacional: {
    ...
    descripcionCorta:
      "Diseñada para alinear personas, liderazgo y estrategia en una misma dirección.",
    capacidades: [
  ...
  sostenibilidad: {
    ...
    descripcionCorta:
      "Para organizaciones que quieren generar valor cuidando el impacto y explorando nuevas oportunidades.",
    capacidades: [
...
export const FORMAS_CONSTRUIR = [
  {
    ...
    desc: "Un acompañamiento cercano para abordar un reto puntual con criterio experto.",
  },
  {
    titulo: "Formación a la medida",
    desc: "Rutas de aprendizaje diseñadas para tu equipo y tu contexto.",
  },
  {
    titulo: "Retos de innovación",
    desc: "Un espacio para explorar preguntas complejas junto a estudiantes y docentes.",
  },
  {
    titulo: "Prácticas empresariales",
    desc: "Talento en formación aportando ideas nuevas a proyectos reales.",
  },
  {
    titulo: "Proyectos aplicados",
    desc: "Equipos interdisciplinarios trabajando contigo sobre casos concretos.",
  },
];
